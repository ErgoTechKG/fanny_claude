...
const translations = {
  en: {
    ...
    'nav.collaborators': 'Research Mentors',
    'nav.aiMentor': 'AI Research Assistant',
    'nav.evaluation': 'Assessment & Certificates',
    ...
    'dashboard.viewCompletedProjects': 'View Completed Projects',
    ...
    'project.noPublications': 'No publications available yet',
  ...
  zh: {
    ...
    'nav.collaborators': '科研导师',
    'nav.aiMentor': 'AI科研助教',
    'nav.evaluation': '评估与证书',
    ...
    'dashboard.viewActiveProjects': '查看进行中的项目',
    'dashboard.viewCompletedProjects': '查看已完成的项目',
    'dashboard.completed': '已完成',
    
    // Project Detail Page
    'project.backToDashboard': '返回仪表盘',
    'project.completed': '已完成',
    'project.inProgress': '进行中',
    'project.timeline': '时间轴',
    'project.team': '团队成员',
    'project.supervisor': '指导教师',
    'project.progress': '进度',
    'project.step': '步骤',
    'project.overview': '项目概览',
    'project.objectives': '项目目标',
    'project.methodology': '研究方法',
    'project.outcomes': '研究成果',
    'project.nextSteps': '下一步计划',
    'project.milestones': '里程碑',
    'project.publications': '相关发表',
    'project.noPublications': '暂无相关发表',
    'project.notFound': '未找到项目',
    'project.tabs.overview': '概览',
    'project.tabs.milestones': '里程碑',
    'project.tabs.publications': '发表',
